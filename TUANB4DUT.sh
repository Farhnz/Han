...
echo -b "AUTHOR    : Han. $green " |lolcat
echo -b "ASSOCIATE : UwUGanG $green " |lolcat
echo -b "ASSOCIATE : UwUGanG $green " |lolcat
echo -b "ASSOCIATE : UwUGanG $green " |lolcat
echo -b "NOTES     : Have Fun! " | lolcat
echo -b "_____________________________________________________________" | lolcat
...
echo -b $green"[#]> UwU" |lolcat
sleep 1
echo -b $green"[#]> UwU" |lolcat

echo -b $green"[#]> OwO" |lolcat
figlet UwU | lolcat
sleep 1
exit
}
